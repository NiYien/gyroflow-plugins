...
class AcceptanceStagesTests(unittest.TestCase):
    setUp = distribution.AcceptanceContractTests.setUp
...
class CompilationStagesTests(unittest.TestCase):
    ...
    def test_ready_packaging_reuses_the_verified_app_without_recompilation(self):
        ...
        def run(command, **kwargs):
            ...
            return ""
        with mock.patch.object(release, "require_acceptance"), \
             mock.patch.object(builder, "require_geometry_gate"), \
    ...
    def test_workflow_gates_all_distribution_steps_and_uploads_only_diagnostics_when_pending(self):
        ...
        self.assertIn("if: startsWith(github.ref, 'refs/tags/')", tagged)
